...
<body>
    <div class="container">
        ...
        <table>
            ...
            <?php foreach ($articlesData as $article): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_article.php?article_id=<?php echo $article["article_id"]; ?>"
                            class="link-button">Edit</a>
        ...
        <a href="create_article.php" class="link-button">Create New Article</a>
