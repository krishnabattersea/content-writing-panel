...
if (isset($_POST["confirm"])) {
    ...
    if ($conn->query($deleteQuery) === TRUE) {
        header("Location: article_management.php"); // Redirect to article management page after successful delete
        exit();
    } else {
        $errorMessage = "Error deleting article: " . $conn->error;
    }
}
?>
...
<body>
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <a href="article_management.php">No, Go Back</a>
        </form>
    </div>
</body>
